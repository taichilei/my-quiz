...
type User struct {
	...
	Email         string  `json:"email"  gorm:"size:100;not null"` // 强制邮箱注册，必填
	EmailVerified bool    `json:"emailVerified" gorm:"default:false"` // 邮箱是否已验证
	CreatedAt     int64   `json:"createdAt"`
	UpdatedAt     int64   `json:"updatedAt"`
}

// NewUser 创建新用户（默认邮箱未验证）
...
// String 安全的字符串表示，防止打印 User 时泄露密码哈希
